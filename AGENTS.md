# AGENTS.md -- Prism: Setup & Onboarding Guide for Coding Agents
...
>
> You should see "Prism" appear in your extensions list.
...
> 6. **Duplicate tabs** are flagged with a purple "(2x)" badge. Click "Close duplicates" to keep one copy.
> 7. **Save a tab for later** by clicking the bookmark icon before closing it. Saved tabs appear in the sidebar.
> 8. **Dashboard auto-refreshes** when tabs change -- no manual refresh needed.
>
...
- Prism is a pure Chrome extension. No server, no Node.js, no npm.
